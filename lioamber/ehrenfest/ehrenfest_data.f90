...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!
   ...
   double precision        :: stored_time
   double precision        :: stored_energy
   double precision        :: stored_dipmom(3)
   complex*16, allocatable :: stored_denson(:,:)
